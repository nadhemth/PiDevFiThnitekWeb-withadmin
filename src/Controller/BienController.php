...
class BienController extends AbstractController
{
    ...
    public function index1(BienRepository $bienRepository): Response
    {
    ...
    #[Route('/{id}/admin', name: 'app_bien_delete1', methods: ['POST'])]
    #[Security('is_granted("ROLE_ADMIN")')]
    public function delete1(Request $request, Bien $bien, BienRepository $bienRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$bien->getId(), $request->request->get('_token'))) {
            $bienRepository->remove($bien, true);
        }
